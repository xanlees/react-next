...
import Khuslowerrow from "./Khuslowerrow";

export default function index({evennumber_top}) {
  if (!evennumber_top) return "ຊອກຫາຂໍ້ມູນບໍ່ເຫັນ!";

  const {results} = evennumber_top;
  return (
    <div>
      <>

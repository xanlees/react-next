...
import Khicklowerrow from "./Khicklowerrow";

export default function index({primenumber_top}) {
  if (!primenumber_top) return "ຊອກຫາຂໍ້ມູນບໍ່ເຫັນ!";

  const {results} = primenumber_top;
  return (
    <div>
      <>

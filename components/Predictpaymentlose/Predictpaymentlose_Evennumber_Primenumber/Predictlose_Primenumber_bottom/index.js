...
import Kickupperrow from "./Kickupperrow";

export default function index({ primenumber_bottom }) {
  if (!primenumber_bottom) return "ຊອກຫາຂໍ້ມູນບໍ່ເຫັນ!";

  const { results } = primenumber_bottom;

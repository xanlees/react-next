...
import High_bottom_row from "./High_bottom_row";

export default function index({ high_bottom }) {
  if (!high_bottom) return "ຊອກຫາຂໍ້ມູນບໍ່ເຫັນ!";

  const { results } = high_bottom;
